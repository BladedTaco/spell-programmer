...
function tile_data(){
	...
	global.spells = {
		...
		constant : 			new __spell_data(bin_counter_spell_tile,/*  TYPE.COUNTER,	*/spr_constant, COLOUR.CONSTANT, " CONSTANT ")
		mana_source : 		new __spell_data(bin_counter_spell_tile,/*  TYPE.COUNTER,	*/spr_mana, COLOUR.MANA, " MANA SOURCE ")
